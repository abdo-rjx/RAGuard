...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/conversations/**").hasAnyRole("USER", "ADMIN", "ANALYST")
                        .requestMatchers("/admin/**").hasRole("ADMIN")
                        .requestMatchers("/policy/**").hasAnyRole("ADMIN", "ANALYST")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:8080", "http://127.0.0.1:8000"));
